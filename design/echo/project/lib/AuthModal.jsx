// AuthModal — sign-in / sign-up sketch.
// Mounted as an overlay on top of a dimmed app shell.

const AuthModal = ({ mode = 'signin' }) => {
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
          <div style={{
            ...
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            color: '#0a0c00', fontFamily: 'var(--font-mono)', fontSize: 14, fontWeight: 600,
          }}>e</div>
          <h2 style={{
            margin: '8px 0 0 0', fontSize: 22, fontWeight: 500,
          ...
          <p style={{ margin: 0, fontSize: 13, color: 'var(--fg-3)', lineHeight: 1.5 }}>
            {isSignup
              ? 'Simulate public reactions before you post.'
        ...
        {/* Email */}
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          <input type="email" placeholder="you@company.com" style={inputStyle} defaultValue="" />
...
const View06_Auth = () => (
  <Frame topbarLabel="" sidebarActive="">
    <div style={{
      position: 'absolute', inset: 0,
...
Object.assign(window, { AuthModal, View06_Auth });
